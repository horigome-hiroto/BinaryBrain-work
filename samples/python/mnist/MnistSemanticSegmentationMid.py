...
net_name               = 'MnistSemanticSegmentationMid_w20_f4_b64_e128_4_8'
data_path              = os.path.join('./data/', net_name)

rtl_sim_path           = '../../verilog/mnist/tb_mnist_semantic_segmentationMid'
rtl_module_name        = 'MnistSemanticSegmentationMid_w20_f4_b64_e128_4_8'
...
if os.path.exists(dataset_fname):
    ...
    source_imgs_test, teaching_imgs_test = transform_data(dataset_test, 256, rows, cols, 29)
...
if not bb.load_networks(data_path, net, name='cnv30'):
    for i in range(31):
        ...
        if not bb.load_networks(data_path, net, name=layer_name):
            # 蒸留
            distillation_layer(os.path.join(data_path, layer_name), net, i, epochs=4)
    ...
    #       learning(os.path.join(data_path, layer_name), net, epochs=2)  # 蒸留で代替
            ...
            learning_layer(os.path.join(data_path, layer_name), net, i, epochs=8)
